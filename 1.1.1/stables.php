...
$basetext=array(
	...
	"desc"=>"`7Behind the inn, and a little to the left of Ye Olde Bank, is as fine a stable as one might expect to find in any village.  In it, Merick, a burly looking dwarf tends to various beasts.`n`nYou approach, and he whirls around, pointing a pitchfork in your general direction, \"`&Ach, sorry m'%s, I dinnae hear ya' comin' up on me, an' I thoht fer sure ye were %s`&; he what been tryin' to improve on his dwarf tossin' skills.  Naahw, wha' can oye do fer ya?`7\" he asks.",
	"lad"=>"lad",
	"lass"=>"lass",
...
// pretranslate these since they are common.
tlschema($schemas['lad']);
$texts['lad'] = translate_inline($texts['lad']);
tlschema();
tlschema($schemas['lass']);
$texts['lass'] = translate_inline($texts['lass']);
tlschema();
...
if ($op==""){
	...
	output($texts['desc'],
			($session['user']['sex']?$texts['lass']:$texts['lad']),getsetting('barkeep','`tCedrik'));
	tlschema();
