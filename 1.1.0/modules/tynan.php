...
function tynan_dohook($hookname,$args){
	...
	case "pvpadjust":
		...
		$thp = round(get_module_pref("hitpoints", false, $row['acctid']), 0);
		$tatk = round(get_module_pref("attack", false, $row['acctid']), 0);
		$tdef = round(get_module_pref("defense", false, $row['acctid']), 0);
