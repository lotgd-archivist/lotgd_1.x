...
function cities_getmoduleinfo(){
	require_once("modules/cities/cities_getmoduleinfo.php");
	return $info;
}
...
function cities_run(){
	require_once("modules/cities/cities_run.php"); //doesn't make much sense to split it... it's the travel & the fight there...
}
