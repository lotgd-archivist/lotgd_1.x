...
function kissingbooth_run()
{
	...
	if ($op == "") {
		while ($kissee == "") {
			$guys = array(getsetting('barkeep','`tCedrik'), "`!Lonestrider", "`@JR`3Min`!ga", "`6Smiythe", "`%Seth", "`&Oliver", "`#MightyE", "`%Kendaer");
			$girls = array("`)Heidi", "`7Petra", "`QSaucy`\$Wench", "`@Foil`&wench", "`5Violet", "`^Ella");
