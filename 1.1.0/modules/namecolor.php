...
function namecolor_form() {
	...
	rawoutput("<form action='runmodule.php?module=namecolor&op=namepreview' method='POST'><input name='newname' value=\"".HTMLEntities($regname)."\"> <input type='submit' class='button' value='Preview'></form>");
