...
if ($op == "") {
	...
	$setup = array(
		...
		,DE,Germany,AI,Anguilla,AR,Argentina,AU,Australia,AT,Austria,BE,Belgium,BR,Brazil,CA,Canada
		...
		"`bAlso make sure you setup a cronjob on your machine using confixx/plesk/admin panel pointing to the cron.php file in your main folder`b,note",
		...
		"resurrectionturns"=>"Modify (+ oder -) the newday turns after a resurrection (with dk spent points) as an absolute (number) or relative (add %...-100%=no turns except mount turns etc),text",
		...
		"forestexploss"=>"How many percent should be lost for being killed in the forest?,range,10,100,1",
