...
if ($op=="" || $op=="sql"){
	...
	rawoutput("<textarea name='sql' class='input' cols='60' rows='10'>".htmlentities($sql)."</textarea><br>");
	...
	rawoutput("&lt;?php<br><textarea name='php' class='input' cols='60' rows='10' style='width: 100%;'>".htmlentities($php)."</textarea><br>?&gt;<br>");
	rawoutput("<input type='submit' class='button' value='$execute'>");
	rawoutput("</form>");
