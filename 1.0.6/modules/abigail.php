...
function abigail_runevent($type) {
	...
	if ($op == "") {
		...
		output("\"`&Happy Day to ye, %s! Can I interest you in a lovely %s for somebody special? It's a fine gift, crafted with care and skill! And, for you, only `%%s`& %s!`7\"`n`n", $greeting, $trinket, $cost, translate_inline(($cost == 1)?"gem":"gems"));
