...
function offering_runevent($type) {
	...
	if ($op == "") {
		...
		output("`7You hand her `^%s`7 gold, and she lifts her head up, looks intently at something above her that only she can see, and whispers, `&\"`\$Ramius!`&\" `7with apparent urgency.`n`n",$amt);
