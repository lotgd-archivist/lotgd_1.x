...
function outhouse_run(){
	...
	if ($op == "pay"){
		...
		if ($takeaway >= $badmusthit){
			...
			if ($session['user']['sex']) {
				$msg = "`2Always cool, %s was seen walking around with a long string of toilet paper stuck to her foot.`n";
			} else {
				$msg = "`2Always cool, %s was seen walking around with a long string of toilet paper stuck to his foot.`n";
			}
