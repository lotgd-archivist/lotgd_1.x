...
function lovers_chat_violet(){
	...
	if (httpget('act')==""){
		...
		output("You go over to `%Violet`0 and help her with the drinks she is carrying.");
		...
		output("You and `%Violet`0 gossip quietly for a few minutes about not much at all.");
