...
if ($op==""){
	...
	if ($entry){
		...
		output("You pull out your Frequent Boozer Card from %s, with 9 out of the 10 slots punched out with a small profile of %s`0's Head.`n`n", $iname,getsetting('barkeep','`)Cedrik'));
