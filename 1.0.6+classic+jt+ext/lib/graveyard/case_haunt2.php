...
if (db_num_rows($result)<=0){
	...
	for ($i=0;$i<db_num_rows($result);$i++){
		...
		rawoutput("<tr class='".($i%2?"trlight":"trdark")."'><td><a href='graveyard.php?op=haunt3&name=".urlencode(HTMLEntities($row['login'], ENT_COMPAT, getsetting("charset", "ISO-8859-1")))."'>");
