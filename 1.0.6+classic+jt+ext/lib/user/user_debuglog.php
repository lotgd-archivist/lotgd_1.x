...
// As mySQL cannot use two different indexes in a single query this query
// can take up to 25s on its own! This happens solely on larger debuglogs
// (where full table scans take quite long), smaller servers should not see
// a change.
...
$sql = "(SELECT $debuglog.* , a1.name AS actorname, a2.name AS targetname
			FROM $debuglog
