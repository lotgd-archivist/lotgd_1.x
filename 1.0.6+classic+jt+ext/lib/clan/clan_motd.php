<?php
		...
		if ($session['user']['clanrank']>=CLAN_OFFICER){
			...
			rawoutput("<textarea name='clanmotd' cols='50' rows='10' class='input' style='width: 100%'>".htmlentities($claninfo['clanmotd'], ENT_COMPAT, getsetting("charset", "ISO-8859-1"))."</textarea><br>");
			...
			if ($claninfo['descauthor']==INT_MAX){
				...
				rawoutput("<textarea name='clandesc' cols='50' rows='10' class='input' style='width: 100%'>".htmlentities($claninfo['clandesc'], ENT_COMPAT, getsetting("charset", "ISO-8859-1"))."</textarea><br>");
			}
