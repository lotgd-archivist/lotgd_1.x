...
if ($op=="" || $op=="sql"){
	...
	rawoutput("&lt;?php<br><textarea name='php' class='input' cols='60' rows='10' style='width: 100%;'>".htmlentities($php, ENT_COMPAT, getsetting("charset", "ISO-8859-1"))."</textarea><br>?&gt;<br>");
	rawoutput("<input type='submit' class='button' value='$execute'>");
	rawoutput("</form>");
