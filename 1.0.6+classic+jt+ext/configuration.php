...
if ($op == "") {
	...
	$setup = array(
		...
		"forestgemchance"=>"Player will find a gem what percent of fights?,range,1,100,1",
		...
		"onlyunreadmails"=>"Only unread mails count towards the inbox limit?,bool",
		...
		*/
		...
		"DB Optimization Settings,title",
		"lastdboptimize"=>"Last Database Optimize,viewonly",
		"optimizeinterval"=>"Days between optimizer runs,int",
	);
