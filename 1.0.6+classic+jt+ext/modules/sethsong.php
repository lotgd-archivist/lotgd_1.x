...
function sethsong_sing()
{
	...
	case 2:
		...
		break;
	case 3:
		output("Gather 'round and I'll tell you a tale`nmost terrible and dark`nof %s`0 and his unclean beer`nand how he hates this bard!`n`n", getsetting('barkeep', '`)Cedrik'));
		output("`0You realize he's right, %s`0's beer really is nasty.", getsetting('barkeep', '`)Cedrik'));
