...
function hitch_dohook($hookname,$args){
	...
	case "inn":
		$oweerrands=get_module_pref("oweerrands");
		if ($oweerrands==1){
			output("`n`3You know that %s`3 has comfortable rooms for the night, but you remember that you promised to stay in the fields with the driver and do errands in the morning.`n", getsetting('barkeep', '`)Cedrik'));
