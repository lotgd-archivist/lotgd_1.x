...
function thieves_fight($costlose) {
	...
	if ($battle){
		...
		if ($victory){
			...
			output("There, he purchases a room from %s`6, and leaves coin for your care, departing before you fully gain consciousness, leaving no opportunity to thank him.`n`n", getsetting("barkeep", "`)Cedrik"));
