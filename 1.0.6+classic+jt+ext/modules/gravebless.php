...
function gravebless_getmoduleinfo() {
	$info = array(
		...
		"settings"=>array(
			...
			"blesscost"=>array("Cost in favor for a blessing from %s`0,int|500", getsetting('deathoverlord', '`$Ramius')),
		...
		"prefs"=>array(
			...
			"ramiusblessed"=>array("Has the player been blessed by %s`0 this DK?,bool|0", getsetting('deathoverlord', '`$Ramius')),
			"ramiuscursed"=>array("Has the player been cursed by %s`0 this DK?,bool|0",getsetting('deathoverlord', '`$Ramius')),
...
function gravebless_dohook($hookname, $args) {
	...
	case "ramiusfavors":
		...
		if (($playerfavor >= $blesscost) &&
			...
			addnav(array("%s`0 Favors", sanitize(getsetting('deathoverlord', '`$Ramius'))));
	...
	case "newday":
		...
		if ($blessed) {
			...
			if ($ramiusarmor) {
				$ramiusbuff = array("name"=>array("`\$Blessed Armor of %s`0", getsetting('deathoverlord', '`$Ramius')),
									"rounds"=>-1,
									"defmod"=>1.25,
				...
				$ramiusbuff = array("name"=>array("`\$Blessed Weapon of %s", getsetting('deathoverlord', '`$Ramius')),
									"rounds"=>-1,
									"atkmod"=>1.25,
									"lifetap"=>$multiplier,
			...
			if ($ramiusarmor) {
				$ramiusbuff = array("name"=>array("`4Cursed Armor of %s", getsetting('deathoverlord', '`$Ramius')),
									"rounds"=>-1,
									"defmod"=>$multiplier,
									"badguyatkmod"=>1.25,
				...
				$ramiusbuff = array("name"=>array("`4Cursed Weapon of %s", getsetting('deathoverlord', '`$Ramius')),
									"rounds"=>-1,
									"atkmod"=>$multiplier,
									"badguydefmod"=>1.25,
