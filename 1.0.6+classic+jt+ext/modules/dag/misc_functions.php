...
function dag_manage(){
	...
	output("Setter: ");
	rawoutput("<input name='setter' value=\"".htmlentities(stripslashes(httppost('setter')), ENT_COMPAT, getsetting("charset", "ISO-8859-1"))."\">");
	output(" Winner: ");
	rawoutput("<input name='getter' value=\"".htmlentities(stripslashes(httppost('getter')), ENT_COMPAT, getsetting("charset", "ISO-8859-1"))."\">");
	output(" Target: ");
	rawoutput("<input name='target' value=\"".htmlentities(stripslashes(httppost('target')), ENT_COMPAT, getsetting("charset", "ISO-8859-1"))."\">");
	output_notl("`n");
	output("Order by: ");
