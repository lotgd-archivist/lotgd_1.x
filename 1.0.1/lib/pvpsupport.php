...
function pvpvictory($badguy, $killedloc)
{
	...
	$args=array('pvpmessageadd'=>"", 'handled'=>false, 'badguy'=>$badguy);
...
function pvpdefeat($badguy, $killedloc, $taunt)
{
	global $session;
	...
	$args=array('taunt'=>$taunt, 'handled'=>false, 'badguy'=>$badguy);
	...
	systemmail($badguy['acctid'],
			...
			array($msg,
				$session['user']['name'], $killedloc, $wonexp, $winamount));
