	...
	case "bartender":
		...
		if ($act==""){
			...
			if ($specialty==""){
				...
				output("\"`3Ok then,`0\" Cedrik says, You're all set.`n`n\"`2That's it?`0\" you ask him.`n`n");
	...
	case "room":
		...
		if ($pay){
			...
			if ($session['user']['boughtroomtoday']){
				...
				output("`n`nYou debate the issue, not wanting to part with your money when the fields offer a place to sleep, however, you realize that the inn is a considerably safer place to sleep, it is far harder for vagabonds to get you in your room while you sleep.");
