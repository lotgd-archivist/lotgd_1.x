...
function drunkard_runevent($type)
{
	...
	if ($roll < $chance) {
		...
		if ($session['user']['sex'] == SEX_MALE) {
			output("As you look up, you notice `%Violet`5 watching you and are embarrased that she is trying to keep from laughing out loud at your mishap.");
		} else {
			output("As you look up, you notice `^Seth`5 watching you and are embarrased that he is trying to keep from laughing out loud at your mishap.");
		}
