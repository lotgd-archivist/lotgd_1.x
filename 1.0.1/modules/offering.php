...
function offering_runevent($type) {
	...
	if ($op == "") {
		...
		output("He would not be pleased!!!\"`n`n");
		output("`7Without another word, she walks away.`n");
		$session['user']['specialinc'] = "";
	}else{
		output("`7You hand her %s gold, and she lifts her head up, looks intently at something above her that only she can see, and whispers, `&\"Ramius!\" `7with apparent urgency.`n`n",$amt);
