...
if ($dp < $dkills) {
	if ($dkills-$dp > 1) {
		...
		function pointsLeft() {
				...
				var hp = parseInt(form.hp.value);
				var ff = parseInt(form.ff.value);
				var de = parseInt(form.de.value);
		...
		output("Max Hitpoints + 5: ");
		rawoutput("</td><td>");
		rawoutput("<input id='hp' name='hp' size='4' maxlength='4' value='$pdkhp' onKeyUp='pointsLeft();' onBlur='pointsLeft();' onFocus='pointsLeft();'>");
		rawoutput("</td></tr><tr><td>");
		output("Forest Fights + 1: ");
		rawoutput("</td><td>");
		rawoutput("<input name='ff' size='4' maxlength='4' value='$pdkff' onKeyUp='pointsLeft();' onBlur='pointsLeft();' onFocus='pointsLeft();'>");
		rawoutput("</td></tr><tr><td>");
		output("Attack + 1: ");
		rawoutput("</td><td>");
		rawoutput("<input name='at' size='4' maxlength='4' value='$pdkat' onKeyUp='pointsLeft();' onBlur='pointsLeft();' onFocus='pointsLeft();'>");
		rawoutput("</td></tr><tr><td>");
		output("Defense + 1: ");
		rawoutput("</td><td>");
		rawoutput("<input name='de' size='4' maxlength='4' value='$pdkde' onKeyUp='pointsLeft();' onBlur='pointsLeft();' onFocus='pointsLeft();'>");
