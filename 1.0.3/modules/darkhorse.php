	...
	if ($what==""){
		...
		if ($who==""){
			...
			if ($session['user']['gold']>=100){
				$sql = "SELECT name,acctid,alive,location,maxhitpoints,gold,sex,level,weapon,armor,attack,race,defense FROM " . db_prefix("accounts") . " WHERE login='$who'";
				$result = db_query($sql);
