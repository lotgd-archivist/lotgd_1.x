...
function jeweler_run(){
	...
	if ($op==""){
		...
		output("`7You hand `3Oliver `7the gems and take the %s from him with a smile, putting it on and admiring yourself in the mirror in front of you.",$type);
		addnav("Shop");
		addnav("Continue Looking", "runmodule.php?module=jeweler");
	} elseif ($op=="sell") {
		output("`3Oliver `7picks up the %s and eyes you carefully.",$type);
		...
		output("`7He examines the %s, then counts out some gems into a pile.",$type);
		...
		$totalheld-- ;
		set_module_pref("totalheld",$totalheld);
		output("`7You hand `3Oliver `7your %s and take the tidy pile of gems from him with a smile, placing them in your purse.",$type);
		addnav("Shop");
		addnav("Continue Looking", "runmodule.php?module=jeweler");
	}
	villagenav();
