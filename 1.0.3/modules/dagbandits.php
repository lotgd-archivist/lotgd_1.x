...
function dagbandits_run(){
	...
	case "search":
		...
		if ($session['user']['turns']<3) {
			output("`2You get a short way outside to but realize you feel far too tired to hike to the bandits headquarters today.");
	...
	case "wolffight":
		$badguy = array(
			"creaturename"=>"Bandit Wolf",
			"creaturelevel"=>$session['user']['level']-1,
			"creatureweapon"=>"Rabid Snapping",
	...
	case "banditfight":
		...
		case 1:
			$badguy = array(
				"creaturename"=>"Bandits Scout",
				"creaturelevel"=>$session['user']['level']-1,
				"creatureweapon"=>"Slim Dagger",
		...
		case 3:
			$badguy = array(
				"creaturename"=>"Bandits Swordsman",
				"creaturelevel"=>$session['user']['level'],
				"creatureweapon"=>"Keen Blade",
				"creatureattack"=>$session['user']['attack'],
		...
		case 4:
			$badguy = array(
				"creaturename"=>"Bandits Captain",
				"creaturelevel"=>$session['user']['level']+1,
				"creatureweapon"=>"Wicked Axe",
