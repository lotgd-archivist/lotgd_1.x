...
if ($op == "") {
	...
	$setup = array(
		...
		"multibasemin"=>"The base number of multiple enemies at minimum is,range,0,100,2",
		"multibasemax"=>"The base number of multiple enemies at maximum is,range,0,100,3",
		...
		*/
		...
		"maxlistsize"=>"Maximum number of items ro be shown in the warrior list,int",
	);
