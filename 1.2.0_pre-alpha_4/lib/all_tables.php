...
return array(
	'accounts'=>array(
		...
		'sex'=>array(
			'name'=>'sex', 'type'=>'tinyint(1) unsigned', 'default'=>'0'
			),
		'specialty'=>array(
			'name'=>'specialty', 'type'=>'varchar(5)',
			),
		'experience'=>array(
		...
		'seenmaster'=>array(
			'name'=>'seenmaster', 'type'=>'tinyint(1) unsigned', 'default'=>'0'
			),
		'level'=>array(
		...
		'alive'=>array(
			'name'=>'alive', 'type'=>'tinyint(1) unsigned', 'default'=>'1'
			),
		'goldinbank'=>array(
		...
		'spirits'=>array(
			'name'=>'spirits', 'type'=>'tinyint(4)', 'default'=>'0'
			),
		'laston'=>array(
		...
		'loggedin'=>array(
			'name'=>'loggedin', 'type'=>'tinyint(1) unsigned', 'default'=>'0'
			),
		'resurrections'=>array(
		...
		'seendragon'=>array(
			'name'=>'seendragon', 'type'=>'tinyint(1) unsigned', 'default'=>'0'
			),
		'dragonkills'=>array(
			'name'=>'dragonkills', 'type'=>'int(11) unsigned', 'default'=>'0'
			),
		'locked'=>array(
			'name'=>'locked', 'type'=>'tinyint(1) unsigned', 'default'=>'0'
			),
		'restorepage'=>array(
		...
		'lastip'=>array(
			'name'=>'lastip', 'type'=>'varchar(15)'
			),
		'uniqueid'=>array(
			'name'=>'uniqueid', 'type'=>'char(32)', 'null'=>'1'
			),
		'dragonpoints'=>array(
			'name'=>'dragonpoints', 'type'=>'text'
			),
		'boughtroomtoday'=>array(
			'name'=>'boughtroomtoday', 'type'=>'tinyint(1)', 'default'=>'0'
			),
		'emailaddress'=>array(
			'name'=>'emailaddress', 'type'=>'varchar(128)'
			),
		'emailvalidation'=>array(
			'name'=>'emailvalidation', 'type'=>'char(32)'
			),
		'sentnotice'=>array(
			'name'=>'sentnotice', 'type'=>'tinyint(1) unsigned', 'default'=>'0'
			),
		'prefs'=>array(
		...
		'refererawarded'=>array(
			'name'=>'refererawarded', 'type'=>'tinyint(1) unsigned', 'default'=>'0'
			),
		'bio'=>array(
		...
		'beta'=>array(
			'name'=>'beta', 'type'=>'tinyint(1) unsigned', 'default'=>'0'
			),
		'slaydragon'=>array(
			'name'=>'slaydragon', 'type'=>'tinyint(1) unsigned', 'default'=>'0'
			),
		'fedmount'=>array(
			'name'=>'fedmount', 'type'=>'tinyint(1) unsigned', 'default'=>'0'
			),
		'regdate'=>array(
			'name'=>'regdate',
			'type'=>'datetime',
	...
	'companions'=>array(
		...
		'cannotdie'=>array(
			'name'=>'cannotdie', 'type'=>'tinyint(1) unsigned', 'null'=>'0', 'default'=>'0'
			),
		'cannotbehealed'=>array(
			'name'=>'cannotbehealed', 'type'=>'tinyint(1) unsigned', 'null'=>'0', 'default'=>'1'
			),
		'companionlocation'=>array(
			'name'=>'companionlocation', 'type'=>'varchar(25)', 'default'=>'all'
			),
		'companionactive'=>array(
			'name'=>'companionactive', 'type'=>'tinyint(1) unsigned', 'default'=>'1'
			),
		...
		'allowinshades'=>array(
			'name'=>'allowinshades', 'type'=>'tinyint(1) unsigned', 'default'=>'0'
			),
		'allowinpvp'=>array(
			'name'=>'allowinpvp', 'type'=>'tinyint(1) unsigned', 'default'=>'0'
			),
		'allowintrain'=>array(
			'name'=>'allowintrain', 'type'=>'tinyint(1) unsigned', 'default'=>'0'
			),
		'key-PRIMARY'=>array(
			'name'=>'PRIMARY',
			'type'=>'primary key',
	...
	'paylog'=>array(
		...
		'processed'=>array(
			'name'=>'processed', 'type'=>'tinyint(1) unsigned', 'null'=>'0',
			'default'=>'0'
			),
		'filed'=>array(
			'name'=>'filed', 'type'=>'tinyint(1) unsigned', 'null'=>'0',
			'default'=>'0'
			),
		'txfee'=>array(
	...
	'creatures'=>array(
		...
		'creatureaiscriptid'=>array(
			'name'=>'creatureaiscriptid', 'type'=>'int(11) unsigned', 'null'=>'1'
			),
		'oldcreatureexp'=>array(
			'name'=>'oldcreatureexp', 'type'=>'int(11)', 'null'=>'1'
			),
		...
		'forest'=>array(
			'name'=>'forest', 'type'=>'tinyint(1) unsigned', 'default'=>'0'
			),
		'graveyard'=>array(
			'name'=>'graveyard', 'type'=>'tinyint(1) unsigned', 'default'=>'0'
			),
		'key-PRIMARY'=>array(
			'name'=>'PRIMARY',
			'type'=>'primary key',
	...
	'mail'=>array(
		...
		'seen'=>array(
			'name'=>'seen', 'type'=>'tinyint(1) unsigned', 'default'=>'0'
			),
		'originator'=>array(
	...
	'modules'=>array(
		...
		'active'=>array(
			'name'=>'active', 'type'=>'tinyint(1) unsigned', 'default'=>'0'
			),
		'filename'=>array(
	...
	'motd'=>array(
		...
		'motdtype'=>array(
			'name'=>'motdtype', 'type'=>'tinyint(1) unsigned', 'default'=>'0'
			),
		'motdauthor'=>array(
			'name'=>'motdauthor', 'type'=>'int(11) unsigned', 'default'=>'0'
			),
	...
	'mounts'=>array(
		...
		'mountactive'=>array(
			'name'=>'mountactive', 'type'=>'tinyint(1) unsigned', 'default'=>'1'
			),
	...
	'petitions'=>array(
		...
		'ip'=>array(
			'name'=>'ip', 'type'=>'varchar(15)', 'default'=>''
			),
		'id'=>array(
			'name'=>'id', 'type'=>'char(32)', 'default'=>''
			),
		'key-PRIMARY'=>array(
			'name'=>'PRIMARY',
			'type'=>'primary key',
	...
	'referers'=>array(
		...
		'ip'=>array(
			'name'=>'ip', 'type'=>'varchar(15)', 'null'=>'1'
			),
		'key-PRIMARY'=>array(
			'name'=>'PRIMARY',
			'type'=>'primary key',
	...
	'scripts'=>array(
		'scriptid'=>array(
			'name'=>'scriptid', 'type'=>'int(11) unsigned', 'extra'=>'auto_increment'
			),
		'description'=>array(
			'name'=>'description', 'type'=>'varchar(255)'
		),
		'file'=>array(
			'name'=>'file', 'type'=>'varchar(255)', 'null'=>'1', 'default'=>null
		),
		'script'=>array(
			'name'=>'script', 'type'=>'text', 'null'=>1, 'default'=>''
		),
		'key-PRIMARY' => array(
			'name' => 'PRIMARY',
			'type' => 'primary key',
