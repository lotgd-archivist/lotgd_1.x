...
$sql = "SELECT subject,messageid,$accounts.name,msgfrom,seen,sent FROM $mail LEFT JOIN $accounts ON $accounts.acctid=$mail.msgfrom WHERE msgto=\"".$user->acctid."\" ORDER BY seen ASC, sent DESC";
$result = DB::query($sql);
