...
if ($replyto!=""){
	...
	$sql = "SELECT ".$mail.".sent,".$mail.".body,".$mail.".msgfrom, ".$mail.".subject,".$accounts.".login, ".$accounts.".superuser, ".$accounts.".name FROM ".$mail." LEFT JOIN ".$accounts." ON ".$accounts.".acctid=".$mail.".msgfrom WHERE msgto=\"".$user->acctid."\" AND messageid=\"".$replyto."\"";
	$result = DB::query($sql);
...
$superusers = array();
if (($user->superuser & SU_IS_GAMEMASTER) && $from > "") {
