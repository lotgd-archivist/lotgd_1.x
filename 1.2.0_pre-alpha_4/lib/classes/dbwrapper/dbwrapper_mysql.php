<?php
/**
 * MySQL Database wrapper class file
 *
 ...
 * database using the mysql functions.
 * 
 * @copyright Copyright © 2002-2005, Eric Stevens & JT Traub, © 2006-2008, Dragonprime Development Team
 * @version Lotgd 1.2.0 DragonPrime Edition
 * @package Core
 ...
 * @license http://creativecommons.org/licenses/by-nc-sa/2.0/legalcode
 */
class DBWrapper_MySQL extends DBWrapper {
	/**
	...
	public function query($sql, $die=true) {
		...
		unset($this->dbinfo['affected_rows']);
	...
	/**
	 * Returns a MySQL resource as an associative array
	 * 
	...
	/**
	 * Determines is MySQL can be used as a database type.
	 * 
	 * Checks that the mysql extension is loaded.
	 */
	static public function canUse() {
		return (bool)extension_loaded('mysql');
	}
}
