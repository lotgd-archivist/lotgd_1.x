...
function outhouse_run(){
	...
	if ($op == "pay"){
		...
		output("While %s over the big hole in the middle of the room with the TP Gnome observing you closely, you almost slip in.`n", translate_inline($user->sex?"squatting":"standing"));
		...
		output("`2Washing your hands is always a good thing.  You tidy up, straighten your %s in your reflection in the water, and head on your way.`0`n", $user->armor);
