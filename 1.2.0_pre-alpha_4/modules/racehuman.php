...
function racehuman_dohook($hookname,$args){
	...
	case "stabletext":
		...
		$args['desc'] = array(
			...
			array("As you approach, Bertold smiles broadly, \"`^Ahh! how can I help you today, my %s?`6\" he asks in a booming voice.", translate_inline($user->sex?'lass':'lad', 'stables'))
		);
