...
function foilwench_runevent()
{
	...
	if ($op=="give"){
		...
		output("\"`&Greetings %s`&, I am `@Foil`&wench, master of all.%s\"`n`n", $user->name, $c);
		...
		output("The old woman sighs, \"`&Yes, mine to teach.  I will teach you how to advance in %s on two conditions.%s\"`n`n", $skills[$user->specialty], $c);
