			...
			if ($gemcount>$user->gems){
				...
				if ($gemcount>0) {
					...
					case 5:
						...
						if (has_buff('transmute')) {
							$buff = Session::getNested('bufflist', 'transmute');
							$buff['rounds'] += get_module_setting('transmuteturns');
							Session::setNested('bufflist', 'transmute', $buff);
						} else {
