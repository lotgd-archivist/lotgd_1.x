...
function check_su_access($level){
	...
	if ($session['user']['superuser'] & $level) {
		...
		output("`\$Ramius, Overlord of Death`) appears before you in a vision, seizing your mind with his, and wordlessly telling you that he finds no favor with you.`n`n");
