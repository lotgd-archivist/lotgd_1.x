...
function motd_form($id) {
	...
	if ($subject=="" || $body=="" || $preview>""){
		...
		output("Subject: ");
		rawoutput("<input type='text' size='50' name='subject' value=\"".HTMLEntities(stripslashes($row['motdtitle']))."\"><br/>");
		output("Body:`n");
		rawoutput("<textarea align='right' class='input' name='body' cols='37' rows='5'>".HTMLEntities(stripslashes($row['motdbody']))."</textarea><br/>");
		if ($row['motditem']>0){
			output("Options:`n");
...
function motd_poll_form() {
	...
	if ($subject=="" || $body==""){
		...
		output("Subject: ");
		rawoutput("<input type='text' size='50' name='subject' value=\"".HTMLEntities(stripslashes($subject))."\"><br/>");
		output("Body:`n");
		rawoutput("<textarea class='input' name='body' cols='37' rows='5'>".HTMLEntities(stripslashes($body))."</textarea><br/>");
