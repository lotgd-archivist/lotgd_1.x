...
function strategyhut_run(){
	...
	if ($op==""){
		...
		$phrases = array(
			...
			"\"`^In PvP, pick your targets with care. If not sure, DON'T... or you'll be explaining to Ramius what happened.`3\"",
			...
			"\"`^Traveling between towns can be dangerous. Heal first.`3\"",
			...
			"\"`^There is no shame in knowing when to run. Better a bruised ego than a visit to Ramius.`3\"",
