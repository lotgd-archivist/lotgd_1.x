...
function forest($noshowmessage=false) {
	...
	if ($noshowmessage!=true){
		...
		output("You move as silently as a soft breeze across the thick mold covering the ground, wary to avoid stepping on a twig or any of the numerous pieces of bleached bone that populate the forest floor, lest you betray your presence to one of the vile beasts that wander the forest.`n");
