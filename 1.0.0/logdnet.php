...
<input type="image" src="images/logdnet.php" border="0" width="62" height="57" name="submit" alt="Donate!">
	...
	output("`2It should be noted that this list is subject to editing and culling by LotGD.net. ");
	...
	output("Because this list is a free service provided by LotGD.net, we reserve the right to remove those who we don't want in the list.`n");
	...
	while (list($key,$val)=each($servers)){
		...
		rawoutput("<td><a href=\"".HTMLEntities($row['address'])."\" target='_blank'>");
