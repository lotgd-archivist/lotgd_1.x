...
function hitch_dohook($hookname,$args){
	...
	case "inn":
		$oweerrands=get_module_pref("oweerrands");
		if ($oweerrands==1){
			output("`n`3You know that Cedrik has comfortable rooms for the night, but you remember that you promised to stay in the fields with the driver and do errands in the morning.`n");
...
function hitch_run(){
	...
	if ($op==""){
		...
		set_module_pref("ridetoday",1);
		output("You help the travelers secure the last of their belongings, and climb aboard.");
		...
		output("`7You help the travelers secure the last of their belongings, and climb aboard.");
