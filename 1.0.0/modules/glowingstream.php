...
function glowingstream_runevent($type,$link)
{
	...
	if ($op=="" || $op=="search"){
		...
		case 2:
			...
			output("You find the strength to open your eyes, and find yourself staring at a tiny fairy who, flying just above your face is inadvertantly sprinkling its fairy dust all over you, granting you the power to crawl once again to your feet.");
