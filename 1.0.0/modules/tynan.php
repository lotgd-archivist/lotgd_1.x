...
function tynan_run(){
	...
	if ($op=="gym"){
		...
		output("A smaller slogan under the bold title reads, \"`#Turning the average farmboy into an Adonis, or farmgirl into Artemis`&.\"`n`n");
