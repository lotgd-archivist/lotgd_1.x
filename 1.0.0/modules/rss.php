...
function rss_run(){
	...
	case "news":
		$feedtitle = "LoGD News";
		$sql = "SELECT newstext,arguments,newsdate,now() AS currenttime FROM " . db_prefix("news") . " ORDER BY newsid DESC LIMIT 10";
	...
	echo "<description>Legend of the Green Dragon -- an browser based text roleplaying game based loosly on the old BBS game Legend of the Red Dragon (LoRD)</description>";
