...
function snowbank_run(){
	...
	if ($op==""){
		...
		if (db_num_rows($result)==1){
			...
			rawoutput("<input type='hidden' name='to' value='".HTMLEntities($row['login'])."'><input type='hidden' name='amount' value='$amt'><input type='submit' class='button' value='$msg'></form>");
