...
if ($op=="edit"){
	...
	output("Taunt: ");
	rawoutput("<input name='taunt' value=\"".HTMLEntities($row['taunt'])."\" size='70'><br>");
	output("The following codes are supported (case matters):`n");
	output("%w = Loser's name (also can be specified as {goodguy}`n");
	output("%x = Loser's weapon (also can be specified as {weapon}`n");
	output("%a = Loser's armor (also can be specified as {armor}`n");
	...
	output("%W = Winner's name (also can be specified as {badguy}`n");
	output("%X = Winner's weapon (also can be specified as {creatureweapon}`n");
